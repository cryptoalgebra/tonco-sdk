...
import {
  ...
  NumberedTickInfo,
  TickInfoWrapper,
} from '../../types/NumberedTickInfo';
import { packJettonOnchainMetadata } from '../common';

const MaxUint120 = BigInt(MaxUint120JSBI.toString());
...
export class PoolContract implements Contract {
  ...
  static poolStateInitConfig(
    ...
    let order = this.orderJettonId(jetton0Wallet, jetton1Wallet);
  ...
  static poolContractConfigToCell(config: PoolContractConfig): Cell {
    ...
    if (Array.isArray(config.ticks)) {
      for (let tickInfo of config.ticks) {
        ticksDict.set(tickInfo.tick, tickInfo.info);
      }
      ticksCell = beginCell()
        .storeDict(ticksDict)
        .endCell();
  ...
  static createFromConfig(
    ...
    const data = this.poolContractConfigToCell(config);
  ...
  async getTickInfo(provider: ContractProvider, tickNumber: number) {
    ...
    if (result.length == 0 || result[0].tickNum != tickNumber) return {};
  ...
  static metaDescription: MetaMessage[] = [
    {
      ...
      acceptor: (visitor: StructureVisitor) => {
        ...
        visitor.visitField({
          ...
          size: 1,
          meta: 'Bool',
          comment: 'Flag that shows if this message have a new admin address',
        });
        visitor.visitField({
          name: `admin_addr`,
          type: `Address`,
        ...
        visitor.visitField({
          ...
          size: 1,
          meta: 'Bool',
          comment: 'Flag is we should start the pool as unlocked',
        });
        ...
        visitor.visitField({
          ...
          size: 16,
          meta: 'Fee',
          comment: `Liquidity provider fee. base in FEE_DENOMINATOR parts. If value is more than ${FEE_DENOMINATOR} value would be default`,
        });
        visitor.visitField({
          name: `lp_fee_base`,
          type: `Uint`,
          size: 16,
          meta: 'Fee',
          comment: `Protocol fee in FEE_DENOMINATOR. If value is more than ${FEE_DENOMINATOR} value would be default`,
        });
        visitor.visitField({
          name: `lp_fee_current`,
          type: `Uint`,
          size: 16,
          meta: 'Fee',
          comment: `Current value of the pool fee, in case of dynamic adjustment. If value is more than ${FEE_DENOMINATOR} value would be default`,
        });
        ...
        visitor.visitField({
          ...
          meta: `Metadata`,
          size: 0,
          comment: 'Metadata for the NFT Collection',
        });
        visitor.visitField({
          ...
          meta: `Metadata`,
          size: 0,
          comment: 'Metadata for the NFT Item',
        });
    ...
    },
    {
      ...
      acceptor: (visitor: StructureVisitor) => {
        ...
        visitor.visitField({
          ...
          size: 124,
          meta: '',
          comment: 'Amount of jetton 0 received by router for the mint',
        });
        visitor.visitField({
          name: `amount1Funded`,
          type: `Coins`,
          size: 124,
          meta: '',
          comment: 'Amount of jetton 1 recived by router for the mint',
        });
        visitor.visitField({
          name: `recipient`,
          type: `Address`,
        ...
        visitor.visitField({
          ...
          size: 128,
          meta: '',
          comment: 'Amount of liquidity to mint',
        });
        visitor.visitField({
          name: `tickLower`,
          type: `Int`,
          size: 24,
          meta: '',
          comment: 'lower bound of the range in which to mint',
        });
        visitor.visitField({
          name: `tickUpper`,
          type: `Int`,
          size: 24,
          meta: '',
          comment: 'upper bound of the range in which to mint',
        });
      },
    },
    {
      ...
      acceptor: (visitor: StructureVisitor) => {
        ...
        visitor.visitField({
          ...
          size: 64,
          meta: '',
          comment: 'Index if the NFT to burn. Should match the sender address',
        });
        visitor.visitField({
          name: `liquidity`,
          type: `Uint`,
          size: 128,
          meta: '',
          comment: 'NFT liquidity amount prior to burn',
        });
        visitor.visitField({
          name: `tickLower`,
          type: `Int`,
          size: 24,
          meta: '',
          comment: 'Lower tick of the NFT. Sanitized by NFTPosition  contract',
        });
        visitor.visitField({
          name: `tickUpper`,
          type: `Int`,
          size: 24,
          meta: '',
          comment: 'Upper tick of the NFT. Sanitized by NFTPosition  contract',
        });
        visitor.visitField({
          name: `liquidity2Burn`,
          type: `Uint`,
        ...
        visitor.enterCell({
          name: 'old_fee_cell',
          comment: 'Fee counters to collect from',
        });
        visitor.visitField({
        ...
        visitor.enterCell({
          name: 'new_fee_cell',
          comment: 'Fee counters to collect to (Used by indexer)',
        });
        visitor.visitField({
    ...
    },
    {
      ...
      acceptor: (visitor: StructureVisitor) => {
        ...
        visitor.visitField({
          ...
          size: 16,
          meta: '',
          comment: 'Liquidity provider fee. base in FEE_DENOMINATOR parts',
        });
        visitor.visitField({
          name: `lp_fee_base`,
          type: `Uint`,
          size: 16,
          meta: '',
          comment: 'Protocol fee in FEE_DENOMINATOR ',
        });
        visitor.visitField({
          name: `lp_fee_current`,
          type: `Uint`,
    ...
    },
    {
      ...
      description:
        'Proxy proof of the jettons funding and mint request to the AccountV3. For more information refer to [AccountV3](account.md)',
      acceptor: (visitor: StructureVisitor) => {
        visitor.visitField({
          name: `op`,
          type: `Uint`,
        ...
        visitor.visitField({
          ...
          size: 124,
          meta: '',
          comment: 'Amount of jetton0 that is funded for the mint',
        });
        visitor.visitField({
          name: `amount1`,
          type: `Coins`,
          size: 124,
          meta: '',
          comment: 'Amount of jetton1 that is funded for the mint',
        });
        visitor.visitField({
          name: `enough0`,
          type: `Coins`,
    ...
    },
    {
      ...
      description:
        'Burn whole or part of nft. Can be called by anyone, but if not called be the owner - would fail later. This operation would compute the amount of the fees that the position is eligible to get and ' +
        'then forwards a message to the [Position NFT](position_nft.md) contract',
      acceptor: (visitor: StructureVisitor) => {
        visitor.visitField({
          name: `op`,
          type: `Uint`,
        ...
        visitor.visitField({
          ...
          size: 64,
          meta: '',
          comment: 'Index if the NFT to burn',
        });
        visitor.visitField({
          name: `liquidity2Burn`,
          type: `Uint`,
        ...
        visitor.visitField({
          ...
          size: 24,
          meta: '',
          comment: 'Lower tick of the NFT. Should match the real one',
        });
        visitor.visitField({
          name: `tickUpper`,
          type: `Int`,
          size: 24,
          meta: '',
          comment: 'Upper tick of the NFT. Should match the real one',
        });
      },
    },
    {
      ...
      acceptor: (visitor: StructureVisitor) => {
        ...
        visitor.visitField({
          ...
          size: 267,
          meta: '',
          comment: 'Owner of the liquidity in swap',
        });
        visitor.visitField({
          name: `source_wallet`,
          type: `Address`,
        ...
        visitor.visitField({
          ...
          size: 124,
          meta: '',
          comment: 'Input amount of the jettons to be swapped',
        });
        visitor.visitField({
          ...
          size: 160,
          meta: 'PriceX96',
          comment: "Limit marginal price. Swap won't go beyond it.",
        });
        visitor.visitField({
          name: `minOutAmount`,
          type: `Coins`,
        ...
        visitor.enterCell({
          name: 'payloads_cell',
          comment: 'Cell with payloads for swap result and change',
        });
        visitor.visitField({
          name: `target_address`,
          type: `Address`,
          size: 267,
          meta: '',
          comment: `Target will receive the result of the swap. Could be addr_none() (*00b*) then owner_address is used`,
        });
        visitor.visitField({
          ...
          size: 124,
          meta: '',
          comment: `Amount of TON to use for forward payload that would be sent with the result of the swap`,
        });
        visitor.visitField({
          name: `ok_forward_payload`,
          type: `Cell`,
          size: 0,
          meta: 'Maybe,Payload',
          comment: `Payload that would be sent with the jettons of the result of the swap`,
        });
        visitor.visitField({
          name: `ret_forward_amount`,
          type: `Coins`,
          size: 124,
          meta: '',
          comment: `Amount of TON to use for forward payload that would be sent with the change for the swap (if any)`,
        });
        visitor.visitField({
          name: `ret_forward_payload`,
          type: `Cell`,
          size: 0,
          meta: 'Maybe,Payload',
          comment: `Payload that would be sent with the jettons of the change of the swap (if any)`,
        });
        visitor.leaveCell({});
      },
    },
