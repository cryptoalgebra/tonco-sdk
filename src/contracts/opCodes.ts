...
export class ContractOpcodes {
  ...
  static POOL_FACTORY_CHANGE_PARAMS: number = 0x87ffe363; // 2281694051
  static POOL_FACTORY_CREATE_POOL: number = 0x2e3034ef; // 774911215
  static POOL_FACTORY_RESET_GAS: number = 0x42a0fb43; // 1117846339
  static POOL_FACTORY_EXECUTE: number = 0xff6310de; // 4284682462
  ...
  static ROUTERTV3_ADD_POOL: number = 0xa1697476; // 2708042870
...
export const OpcodesLookup = {
  ...
  0x2e3034ef: 'POOL_FACTORY_CREATE_POOL,ROUTERV3_CREATE_POOL',
  ...
  0x67f2f394: 'ROUTERV3_CHANGE_POOL_FACTORY',
  ...
  0xff6310de: 'POOL_FACTORY_EXECUTE',
