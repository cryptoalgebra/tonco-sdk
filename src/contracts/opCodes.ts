...
export class ContractOpcodes {
    ...
    static ROUTERV3_TON_TRANSFER_NOTIFICATION : number = 0x7c0eb31a // 2081338138
...
export const OpcodesLookup : {[x : number] : string} = {    
    ...
    0x7c0eb31a : "ROUTERV3_TON_TRANSFER_NOTIFICATION",
...
export class ContractErrors {
    ...
    static ROUTERV3_INVALID_SIGNATURE      : number =  33 // 0x21
    static ROUTERV3_INVALID_SUBWALLET_ID   : number =  34 // 0x22
    static ROUTERV3_INVALID_CREATED_AT     : number =  35 // 0x23
    static ROUTERV3_ALREADY_EXECUTED       : number =  36 // 0x24
    static ROUTERV3_INVALID_MESSAGE_TO_SEND : number =  37 // 0x25
    static ROUTERV3_INVALID_TIMEOUT        : number =  38 // 0x26
    static ROUTERV3_NO_VAULT               : number = 151 // 0x97
    static ROUTERV3_VAULT_NOT_EMPTY        : number = 152 // 0x98
...
export const ErrorsLookup : {[x : number] : string} = {    
    33 : "ROUTERV3_INVALID_SIGNATURE",
    34 : "ROUTERV3_INVALID_SUBWALLET_ID",
    35 : "ROUTERV3_INVALID_CREATED_AT",
    36 : "ROUTERV3_ALREADY_EXECUTED",
    37 : "ROUTERV3_INVALID_MESSAGE_TO_SEND",
    38 : "ROUTERV3_INVALID_TIMEOUT",
    ...
    151 : "ROUTERV3_NO_VAULT",
    152 : "ROUTERV3_VAULT_NOT_EMPTY",
