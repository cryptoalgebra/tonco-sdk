...
export class ContractOpcodes {
    ...
    static ACCOUNTV4_RESET_GAS       : number = 0x42a0fb43 // 1117846339
    static ACCOUNTV4_ADD_LIQUIDITY   : number = 0x3ebe5431 // 1052660785
    static ACCOUNTV4_CB_ADD_LIQUIDITY : number = 0x56dfeb8a // 1457515402
    static ACCOUNTV4_GETTER_LP_ACCOUNT_DATA : number = 0x1d439ae0 // 490969824
    static ACCOUNTV4_DIRECT_ADD_LIQUIDITY : number = 0x4cf82803 // 1291331587
    static ACCOUNTV4_REFUND_ME       : number = 0xbf3f447 // 200537159
    static ACCOUNTV4_CB_REFUND_ME    : number = 0x89446a42 // 2302962242
    static FEEVAULT_COLLECT          : number = 0x3d4e7f1a // 1028554522
    ...
    static POOL_FACTORY_CHANGE_ADMIN : number = 0x246189c4 // 610372036
    ...
    static POSITIONNFTV3_POSITION_TRASH : number = 0x89e85f90 // 2313707408
    ...
    static ROUTERV3_TON_TRANSFER     : number = 0x1f3835d // 32736093
    static ROUTERV3_VAULT_INIT       : number = 0x36a39d8e // 916692366
    static ROUTERV3_VAULT_DEPOSIT    : number = 0xcbc2ee07 // 3418549767
    static ROUTERV3_VAULT_WITHDRAW   : number = 0x74e15b46 // 1960926022
    static ROUTERV3_FUND_WITH_VAULT  : number = 0x2c4547ea // 742737898
...
export const OpcodesLookup : {[x : number] : string} = {    
    0x15 : "JETTON_MINT",
    0x1f3835d : "ROUTERV3_TON_TRANSFER,TONPROXY_MINTER_TON_TRANSFER",
    ...
    0xbf3f447 : "ACCOUNTV3_REFUND_ME,ACCOUNTV4_REFUND_ME",
    ...
    0x1d439ae0 : "ACCOUNTV3_GETTER_LP_ACCOUNT_DATA,ACCOUNTV4_GETTER_LP_ACCOUNT_DATA",
    0x246189c4 : "POOL_FACTORY_CHANGE_ADMIN",
    0x29d22935 : "TONPROXY_MINTER_RESET_GAS",
    0x2c4547ea : "ROUTERV3_FUND_WITH_VAULT",
    ...
    0x36a39d8e : "ROUTERV3_VAULT_INIT",
    0x3d4e7f1a : "FEEVAULT_COLLECT",
    0x3ebe5431 : "ACCOUNTV3_ADD_LIQUIDITY,ACCOUNTV4_ADD_LIQUIDITY",
    0x42a0fb43 : "ACCOUNTV3_RESET_GAS,ACCOUNTV4_RESET_GAS,POOL_FACTORY_RESET_GAS,POOLV3_RESET_GAS,ROUTERV3_RESET_GAS",
    0x441c39ed : "POOLV3_INIT",
    0x4468de77 : "POOLV3_FUND_ACCOUNT",
    0x46ca335a : "POSITIONNFTV3_POSITION_BURN",
    0x4cf82803 : "ACCOUNTV3_DIRECT_ADD_LIQUIDITY,ACCOUNTV4_DIRECT_ADD_LIQUIDITY",
    0x511a4463 : "NFT_EDITORSHIP_ASSIGNED,POSITIONNFTV3_EDITORSHIP_ASSIGNED",
    0x530b5f2c : "POOLV3_START_BURN",
    0x56dfeb8a : "ACCOUNTV3_CB_ADD_LIQUIDITY,ACCOUNTV4_CB_ADD_LIQUIDITY",
    ...
    0x74e15b46 : "ROUTERV3_VAULT_WITHDRAW",
    0x7bdd97de : "JETTON_BURN_NOTIFICATION",
    0x80139ad6 : "POOLV3_FILL_TICK_M",
    0x81702ef8 : "POOLV3_MINT",
    0x87ffe363 : "ROUTERV3_CHANGE_PARAMS",
    0x89446a42 : "ACCOUNTV3_CB_REFUND_ME,ACCOUNTV4_CB_REFUND_ME",
    0x89e85f90 : "POSITIONNFTV3_POSITION_TRASH",
    ...
    0xcbc2ee07 : "ROUTERV3_VAULT_DEPOSIT",
...
export class ContractErrors {
    static ACCOUNTV4_INVALID_SIGNATURE     : number =  33 // 0x21
    static ACCOUNTV4_INVALID_SUBWALLET_ID  : number =  34 // 0x22
    static ACCOUNTV4_INVALID_CREATED_AT    : number =  35 // 0x23
    static ACCOUNTV4_ALREADY_EXECUTED      : number =  36 // 0x24
    static ACCOUNTV4_INVALID_MESSAGE_TO_SEND : number =  37 // 0x25
    static ACCOUNTV4_INVALID_TIMEOUT       : number =  38 // 0x26
    static ACCOUNTV4_NO_VAULT              : number = 151 // 0x97
    static ACCOUNTV4_VAULT_NOT_EMPTY       : number = 152 // 0x98
    ...
    static JETTON_STABLE_INVALID_OP        : number =  72 // 0x48
    static JETTON_STABLE_WRONG_OP          : number = 65535 // 0xffff
    static JETTON_STABLE_NOT_OWNER         : number =  73 // 0x49
    static JETTON_STABLE_NOT_VALID_WALLET  : number =  74 // 0x4a
    static JETTON_STABLE_WRONG_WORKCHAIN   : number = 333 // 0x14d
    static JETTON_STABLE_CONTRACT_LOCKED   : number =  45 // 0x2d
    static JETTON_STABLE_BALANCE_ERROR     : number =  47 // 0x2f
    static JETTON_STABLE_NOT_ENOUGH_GAS    : number =  48 // 0x30
    static JETTON_STABLE_INVALID_MESSAGE   : number =  49 // 0x31
    ...
    static ROUTERV3_INSUFFICIENT_TON       : number =  87 // 0x57
    static ROUTERV3_TIMELOCK_NOT_RESPECTED : number = 114 // 0x72
    static TONPROXY_MINTER_INSUFFICIENT_GAS : number =  83 // 0x53
    static TONPROXY_MINTER_INVALID_ADDRESS : number =  84 // 0x54
    static TONPROXY_MINTER_LOW_AMOUNT      : number =  87 // 0x57
    static TONPROXY_MINTER_LOW_BALANCE     : number =  88 // 0x58
    static TONPROXY_MINTER_INVALID_AMOUNT  : number =  89 // 0x59
    static TONPROXY_MINTER_WRONG_WORKCHAIN : number =  85 // 0x55
    static TONPROXY_MINTER_INVALID_BODY    : number =  90 // 0x5a
}

export const ErrorsLookup : {[x : number] : string} = {    
    33 : "ACCOUNTV4_INVALID_SIGNATURE",
    34 : "ACCOUNTV4_INVALID_SUBWALLET_ID",
    35 : "ACCOUNTV4_INVALID_CREATED_AT",
    36 : "ACCOUNTV4_ALREADY_EXECUTED",
    37 : "ACCOUNTV4_INVALID_MESSAGE_TO_SEND",
    38 : "ACCOUNTV4_INVALID_TIMEOUT",
    45 : "JETTON_STABLE_CONTRACT_LOCKED",
    47 : "JETTON_STABLE_BALANCE_ERROR",
    48 : "JETTON_STABLE_NOT_ENOUGH_GAS",
    49 : "JETTON_STABLE_INVALID_MESSAGE",
    72 : "JETTON_STABLE_INVALID_OP",
    73 : "JETTON_NOT_ADMIN,JETTON_STABLE_NOT_OWNER",
    74 : "JETTON_UNOUTHORIZED_BURN,JETTON_STABLE_NOT_VALID_WALLET",
    ...
    83 : "POOLV3_INSUFFICIENT_GAS,TONPROXY_MINTER_INSUFFICIENT_GAS",
    84 : "TONPROXY_MINTER_INVALID_ADDRESS",
    85 : "TONPROXY_MINTER_WRONG_WORKCHAIN",
    86 : "POOLV3_INVALID_TOKEN",
    87 : "POOLV3_LOW_AMOUNT,ROUTERV3_INSUFFICIENT_TON,TONPROXY_MINTER_LOW_AMOUNT",
    88 : "TONPROXY_MINTER_LOW_BALANCE",
    89 : "TONPROXY_MINTER_INVALID_AMOUNT",
    90 : "POOLV3_MATH_ERROR,TONPROXY_MINTER_INVALID_BODY",
    ...
    151 : "ACCOUNTV4_NO_VAULT",
    152 : "ACCOUNTV4_VAULT_NOT_EMPTY",
    ...
    333 : "COMMON_WRONG_WORKCHAIN,JETTON_STABLE_WRONG_WORKCHAIN",
    ...
    65535 : "COMMON_WRONG_OP,JETTON_STABLE_WRONG_OP",
}